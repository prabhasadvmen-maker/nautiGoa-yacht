export const YACHTS_DATA = [
  {
    ...
    amenities: [
      ...
      "Air-Conditioned Luxury Salon",
      "Flybridge Sun Deck with Wet Bar",
      "Bose Sound System & Bluetooth",
      "Sunbathing Bow Lounge",
      "Complimentary Ice & Refreshments",
      "Snorkeling & Safety Gear",
      "Custom Decor Available"
    ],
    includes: [
      "Fuel & Port Taxes Included",
      "Dedicated Captain & Hospitality Crew",
      "Welcome Drinks & Gourmet Snacks",
  ...
  },
  {
    ...
    amenities: [
      ...
      "Spacious Teak Dining Deck",
      "Bespoke Catering & BBQ Grill",
      "High-end Surround Audio",
      "Air-Conditioned VIP Suites",
      "Luxury Leather Lounge Seating",
      "Drone Photography Friendly"
    ],
    includes: [
      "Full Scenic Coastline Route",
      "Chilled Mineral Water, Juices & Soft Drinks",
      "Safety Briefing & Life Vests",
      "Onboard Bluetooth DJ Setup"
    ]
  },
  {
    id: "lagoon-450-catamaran",
    name: "Lagoon 450 Luxury Catamaran",
    tagline: "Unmatched Ocean Stability & Spacious Lounging",
    location: "Goa",
    capacity: "25 Guests",
    length: "45 ft Dual Hull",
    speed: "14 Knots",
    cabins: "4 Spacious Cabins",
    bathrooms: "4 Private Heads",
    ...
    amenities: [
      "Dual Hull Anti-Roll Stability",
      "Bow Trampoline Sun Net Lounge",
      "360-Degree Panoramic Glass Salon",
      "Outdoor Dining & Cocktail Area",
      "Bluetooth Sound Bar System",
      "Dedicated Captain & Service Crew",
      "Custom Balloon & Floral Decor Setup"
    ],
    includes: [
      "Goa Coastal & Islands Cruise",
      "Complimentary Ice Box & Soft Beverages",
      "Life Jackets & Swimming Gear",
  ...
  },
  {
    ...
    amenities: [
      "Full Multi-level Flybridge Lounge",
      "VIP Master Suite & Guest Cabins",
      "Bespoke Gourmet Catering Services",
      "High-Definition Sound & TV Systems",
      "Hydraulic Swim Platform",
      "Professional Crew & Butler Service"
    ],
    includes: [
      "Gateway of India to Marine Drive Route",
      "Refreshments & Mineral Water",
      "Full Safety & Navigation Gear"
    ]
  },
  {
    id: "ferretti-70",
    name: "Ferretti 70 Ocean Sovereign",
    tagline: "Pure Opulence & Sleek Maritime Performance",
    location: "Dubai",
    capacity: "18 Guests",
    length: "70 ft",
    speed: "30 Knots",
    ...
    amenities: [
      "Captain & 2 Professional Deck Crew",
      "Flybridge Jacuzzi Option",
  ...
  {
    id: "sea-ray-320-speedboat",
    name: "Sea Ray 320 Sundancer",
    tagline: "Agile Speed, Romantic Setting & Sun Lounging",
    location: "Goa",
    capacity: "8 Guests",
    length: "32 ft",
    speed: "38 Knots",
    cabins: "1 Air-conditioned Cabin",
    ...
    amenities: [
      "Romantic Candlelight & Flower Setup",
      "Wrap-around Bow Sun Lounger",
    ...
    includes: [
      "Mandovi River & Panjim Coast Tour",
      "Chilled Champagne Glasses & Soft Drinks",
...
export const TESTIMONIALS_DATA = [
  {
    id: 1,
    name: "Siddharth & Ananya M.",
    location: "Mumbai",
    rating: 5,
    comment: "Booked the Lagoon Catamaran for my birthday celebration in Goa. The NautiGoa team executed the drone shoot and decoration perfectly! 100% genuine & hassle-free direct booking.",
    yacht: "Lagoon 450 Catamaran"
  },
  {
    id: 2,
    name: "Rahul & Meera V.",
    location: "Goa",
    rating: 5,
    comment: "I planned a surprise proposal on the Sea Ray Sundancer at Panjim sunset. The floral decoration, music, and captain's hospitality were world-class! Thank you NautiGoa Yachts!",
    yacht: "Sea Ray 320 Sundancer"
  },
  {
    id: 3,
    ...
    location: "Dubai",
    rating: 5,
    comment: "Hosted our corporate partners on the Princess 62 in Dubai Marina. Exceptional service, pristine yacht condition, and prompt communication via WhatsApp. Highly recommended!",
    yacht: "Princess 62 Superyacht"
  }
];

export const REASON_FEATURES = [
  {
    title: "Direct Verified Booking",
    desc: "Zero middlemen fees and 100% verified yacht availability guaranteed directly by NautiGoa."
  },
  {
    title: "Certified Professional Crew",
    desc: "Experienced captains and hospitality crew ensuring total maritime safety and five-star service."
  },
  {
    title: "Bespoke Customization",
    desc: "Tailored luxury decor, drone videography, gourmet catering, and live entertainment on demand."
  },
  {
    title: "Prime Locations",
    desc: "Panjim Britona dock in Goa, Gateway of India in Mumbai, and Dubai Marina in UAE."
  }
];
